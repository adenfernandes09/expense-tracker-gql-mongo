...
import TransactionFormShimmerUI from "../components/loaders/TransactionLoader";
...
const TransactionPage = () => {
  const { id } = useParams();
  const { loading, data } = useQuery(GET_TRANSACTION_BY_ID, {
    variables: {
      id: id,
    },
  });
  ...
  const handleSubmit = async (e) => {
	...
	try {
		...
		toast.success("Updated the transaction successfully")
	} catch (error) {
  ...
  if (loading) return <TransactionFormShimmerUI />;
